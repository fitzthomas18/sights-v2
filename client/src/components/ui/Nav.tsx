...
import { ConfigSwitcherBasic } from "../widget/ConfigSwitcherBasic";
    ...
    <div>
      <nav className="border-gray-200 bg-gray-50 dark:bg-neutral-800 dark:border-neutral-600">
        <div className="container flex flex-wrap items-center justify-between mx-auto p-4 relative">
          ...
          <div className="flex basis-1/3 justify-start md:order-2 space-x-2">
            <ConfigSwitcherBasic onConfigChange={onConfigChange} />
          </div>
