...
export class DefaultService {
   ...
   * @throws ApiError
   */
  public driveDrivePost(requestBody: MoveMotorsParams): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
      url: "/drive/",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public sensorListSensorListGet(): CancelablePromise<
   ...
   * @throws ApiError
   */
  public sensorSensorSensorIdGet(sensorId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public armHomeArmPresetPresetPost(preset: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
